...
# 3. Save Cleaned Text (Requirement: txt file in data folder)
os.makedirs('data', exist_ok=True)
file_path = 'data/ecb_press_conference.txt'
with open(file_path, 'w', encoding='utf-8') as f:
    f.write("\n\n".join(paragraphs))

# 4. Paragraph-level Sentiment Analysis using TextBlob
data = []
...
# 5. Word Frequency and Word Cloud
